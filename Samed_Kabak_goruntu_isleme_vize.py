...
import screen_brightness_control as sbc  # Ekran parlaklığı kontrol kütüphanesi
...
def draw_landmarks_on_image(rgb_image, detection_result):
    ...
    for idx in range(len(hand_landmarks_list)):
        ...
        x1, y1 = koordinat_getir(hand_landmarks, 8, h, w)  # İşaret parmağı ucu
        ...
        # Parlaklık mesafeye göre ayarlanıyor
        brightness = np.clip(uzaklik, 10, 100)  # 10 ile 100 arası parlaklık değeri
        try:
